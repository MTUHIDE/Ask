...
<div class="stripe" style="background: #FFFFFF; border: none; margin-top: 1.5vh;">
    ...
    <g:link style="color: inherit; text-decoration: inherit;" action="saveResponse2" params="[option:option2, idlist:idlist, vid:vid]">
        <div class="ans2" id="button2">
            ${option2}
        </div>
    </g:link>
    <g:link style="color: inherit; text-decoration: inherit;" action="saveResponse2" params="[option:option3, idlist:idlist, vid:vid]">
        <div class="ans3" id="button2">
            ${option3}
        </div>
    </g:link>
    <g:link style="color: inherit; text-decoration: inherit;" action="saveResponse2" params="[option:option4, idlist:idlist, vid:vid]">
